...
public interface KeyWordFunctions extends AutoCloseable
{
    ...
    */
   static KeyWordFunctions buildWebDriver(String url, String browserName, ArrayList<String> excelName)
   {
      return CommonFunctions.buildWebDriver(url, browserName, excelName);
   }
    ...
    * @return - Instance of WebBrowser
    */
   static KeyWordFunctions buildRemoteWebDriver(String url, String browserName, Method method)
   {
   ...
   void assertElementExist(String locator);


   void assertTrue(String expectedValue, String actualValue, String message);


   void assertSame(int expectedValue, int actualValue, String message);


   void assertEquals(String expectedValue, String actualValue, String message);


   void assertEquals(int expectedValue, int actualValue, String message);
