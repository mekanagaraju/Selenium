...
class CommonFunctions implements KeyWordFunctions
{
   protected static final Logger log = LoggerFactory.getLogger(KeyWordFunctions.class);
   ...
   public static CommonFunctions buildWebDriver(String url, String browserName, ArrayList<String> excelName)
   {
      System.gc();
      log.info("");
      log.info("=========================================================");
      log.info("Test: {}", excelName.get(0));
      log.info("Test Description: {}", excelName.get(1));
      log.info("=========================================================");
   ...
   public void assertElementExist(String locator)
   {
      ...
      log.info(locator + " Present on the screen: TRUE");
   }
